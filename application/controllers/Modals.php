    ...
    public function printModal(){
        ...
        <div class="modal-content">
          ...
          <div class="modal-body" style="height: 345px">
                <div><iframe class="col-md-12" height="315" src="'.$_POST['href'].'" frameborder="0" allowfullscreen></iframe></div>
          </div>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">';
            echo "<div class='row well'>";
                $table = new Puntuaciones($_GET['y']);
                $table->printTopByNombre($_POST['usu']);
            echo '</div>';
            echo '</div>
                <div class="modal-footer">
                    <br />
