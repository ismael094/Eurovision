...
|--------------------------------------------------------------------------
|
| Configuaracion que tiene el nombre del nombre de la carpeta del tema 
| con el fin de cargar las url dinamicas si esta vacio por defecto
|
*/
...
|
*/
$config['themePath'] = 'resources/themes/';
...
|
*/
$config['encryption_key'] = 'JwCbfueVmdoSM8GKNXArn5m0WygzzX3u';
