...
(function($) {
  ...
  function defaultRowWriter(rowIndex, record, columns, cellWriter) {
    var tr = '';
    var ind = record['dynatable-original-index'];
    
    var titulo = record['titulo'];
    var interprete = record['autor'];
    var enlace = record['enlace'];
    var id = record['id'];;
    ...
    return '<tr class="dyCo" data-name="'+titulo+' - '+interprete+'" data-enlace="'+enlace+'" data-id="'+id+'">' + tr + '</tr>';
  };
